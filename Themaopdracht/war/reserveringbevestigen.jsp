...
<head> 
	...
	<title>Parkeer reservering bevestigen Page</title> 
</head> 
<body>
	...
	<%@ page import="java.util.ArrayList,domeinklassen.Reservering" %>
		...
		if(gekozen == null){
			...
			if(reserveringen == null){
				...
				out.println("<h2><span>Kies de reservering die bevestigd moet worden: </span></h2>");
				out.println("<table>");
				out.println("<tr>");
				...
				boolean eerste=true; 
		 		...
		 		out.println("</table>");
				out.println("<input type=submit name=knop value=bevestigen />"); 	
			}
		}
		%>
		</div>
