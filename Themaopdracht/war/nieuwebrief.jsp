...
De medewerkers van AutoTotaalDienst Utrecht
			...
			<p><input type="hidden" name="klantnummer" value="<%=deKlant.getKlantnummer()%>" />
			<input type="submit" name="knop" value="Versturen" /></p>
			<%
		}
		else{
			...
			%>
			<h2><span>Selecteer de klant aan wie u een brief wilt schrijven</span></h2>
			<table>
			<tr>
				<th>X</th>
				<th>Klantnummer</th>
