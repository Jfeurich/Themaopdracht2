...
public class Main {
	...
	public static void main(String[] args) throws Exception{
		...
		Auto a2 = new Auto("22ww22", "Fiat", "Punto", k2);
		Auto a3 = new Auto("33ee33","Ferrari","Testarossa",k2);
		Auto a4 = new Auto("ww33ww","Lamborghini","Murcielago SV670LP",k3);
		Klus rep1 = new Reparatie("01-01-2010", "Uitlaat is kapot", a1);
		Klus rep2 = new Reparatie("02-01-2010", "Uitlaat is kapot", a1);
		Klus rep3 = new Reparatie("03-01-2010", "Uitlaat is kapot", a1);
		Klus rep4 = new Reparatie("04-01-2010", "Uitlaat is kapot", a1);
		Klus rep5 = new Reparatie("05-01-2010", "Uitlaat is kapot", a1);
		Klus rep6 = new Reparatie("06-01-2010", "Uitlaat is kapot", a1);
		b.voegKlusToe(rep1);
		b.voegKlusToe(rep2);
		b.voegKlusToe(rep3);
		b.voegKlusToe(rep4);
		...
		Klus rep7 = new Reparatie("02-01-2014","Auto is te rood",a3);
		b.voegKlusToe(rep7);
		rep7.setStatus("Voltooid");rep2.addManuren(50);
		Klus ond1 = new Onderhoudsbeurt("02-01-2014", "APK", a4);
